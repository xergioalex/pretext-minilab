...
export const demos: DemoMeta[] = [
  ...
  },
  {
    ...
    title: 'Living Document System',
    summary: 'An autonomous editorial surface that reprioritizes cards and reflows text blocks in real time.',
    category: 'advanced',
    featured: true,
    flagship: true,
  ...
  {
    slug: 'text-fluid',
    title: 'Text Fluid Field',
    summary: 'A paragraph bends through a simulated velocity field instead of a fixed container shape.',
    category: 'spectacular',
    featured: true,
    flagship: false,
    apis: ['prepareWithSegments()', 'layoutNextLine()'],
  ...
  {
    slug: 'text-origami',
    title: 'Text Origami Panels',
    summary: 'Text flows across foldable paper panels whose geometry changes with each crease.',
    category: 'spectacular',
    featured: true,
    flagship: false,
    apis: ['prepareWithSegments()', 'layoutNextLine()'],
  ...
  },
  {
    ...
    summary: 'A cinematic subtitle engine with safe zones, speaker separation, emphasis, and timing-aware wrapping.',
    category: 'practical',
    featured: true,
    flagship: false,
    apis: ['prepareWithSegments()', 'layoutWithLines()'],
  ...
  {
    slug: 'topology-morph',
    title: 'Topology Morph',
    summary: 'One document migrates across radically different region topologies while keeping reading continuity.',
    category: 'advanced',
    featured: true,
    flagship: false,
    apis: ['prepareWithSegments()', 'layoutNextLine()'],
